...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
        ...
        try {
            ...
            // NOTE: Agent status check removed — transfers are allowed to any agent
            // regardless of their online/offline status. The agent will receive a
            // push notification and can accept the transferred call.
