...
export class ClinicBudgetStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: ClinicBudgetStackProps) {
        ...
        // DYNAMODB TABLE
        // ========================================
        // Partition Key: clinicName (String) - The clinic name/location
        // No sort key needed as each clinic has one budget value
        ...
        // Create seeder Lambda to populate initial data
        ...
        // Create custom resource to seed data on deployment
