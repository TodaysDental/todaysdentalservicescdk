...
// src/services/chime/call-hungup-v2.ts
var call_hungup_v2_exports = {};
__export(call_hungup_v2_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(call_hungup_v2_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    const assignedAgentId = typeof freshCall.assignedAgentId === "string" ? String(freshCall.assignedAgentId).trim() : "";
