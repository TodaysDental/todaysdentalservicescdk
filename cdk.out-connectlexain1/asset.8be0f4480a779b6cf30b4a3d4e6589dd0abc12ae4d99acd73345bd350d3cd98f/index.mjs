...
async function getUserPermissionsFromDb(email) {
...
function generatePolicy(principalId, effect, resource, payload, userPermissions) {
  ...
  const clinicRolesZForContext = shouldCompressClinicRoles ? encodeClinicRolesForContext(userPermissions.clinicRoles) : void 0;
  return {
    principalId,
    policyDocument: {
      Version: "2012-10-17",
...
function encodeClinicRolesForContext(clinicRoles) {
