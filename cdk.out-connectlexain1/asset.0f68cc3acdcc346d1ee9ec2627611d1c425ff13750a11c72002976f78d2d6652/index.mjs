  ...
  try {
    ...
    await ddb.send(new PutCommand({
      ...
      Item: {
        ...
        // Primary key
        email,
        blacklistedAt: (/* @__PURE__ */ new Date()).toISOString(),
        ttl
        // DynamoDB TTL field for auto-cleanup
      }
    }));
