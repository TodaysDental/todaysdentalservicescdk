...
// src/services/ai-agents/websocket-connect.ts
...
var handler = async (event) => {
  ...
  const isDevelopment = process.env.NODE_ENV === "development" || process.env.AWS_SAM_LOCAL === "true";
  ...
  const isAllowedOrigin = origin === "" || ALLOWED_ORIGINS_LIST.some(
