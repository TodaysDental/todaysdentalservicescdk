...
// src/services/rcs/rcs-auto-reply-config.ts
var rcs_auto_reply_config_exports = {};
__export(rcs_auto_reply_config_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(rcs_auto_reply_config_exports);
...
async function getStoredConfig(clinicId) {
  ...
  return {
    ...
    updatedBy: typeof item.updatedBy === "string" ? item.updatedBy : void 0
  };
}
async function validateAgentForClinic(clinicId, agentId) {
  if (!AI_AGENTS_TABLE) {
...
async function handler(event) {
  ...
  if (!clinicId)
    return badRequest(headers, "clinicId is required");
