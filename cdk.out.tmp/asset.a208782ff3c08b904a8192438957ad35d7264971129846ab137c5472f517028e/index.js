...
// src/services/marketing/analytics-sync.ts
var analytics_sync_exports = {};
__export(analytics_sync_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(analytics_sync_exports);
...
var handler = async (event) => {
  console.log("Analytics sync started:", (/* @__PURE__ */ new Date()).toISOString());
  try {
