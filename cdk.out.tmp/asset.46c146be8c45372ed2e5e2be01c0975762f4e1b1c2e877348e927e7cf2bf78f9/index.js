...
// src/services/chatbot/websocket-connect.ts
var websocket_connect_exports = {};
__export(websocket_connect_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(websocket_connect_exports);
...
// src/services/chatbot/websocket-connect.ts
var dynamoClient2 = new import_client_dynamodb2.DynamoDBClient({ region: process.env.AWS_REGION });
