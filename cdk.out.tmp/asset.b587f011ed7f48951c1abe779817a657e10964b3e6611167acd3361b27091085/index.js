...
async function updateConfig(event, userPerms, clinicId) {
  ...
  const isToggleOnly = (typeof body.aiInboundEnabled === "boolean" || typeof body.aiOutboundEnabled === "boolean") && !body.inboundAgentId && !body.outboundAgentId;
  ...
  const aiInboundEnabled = typeof body.aiInboundEnabled === "boolean" ? body.aiInboundEnabled : existing?.aiInboundEnabled ?? true;
