...
async function sendFcmV1Notification(deviceToken, notification, platform = "android") {
  ...
  if (platform === "android") {
    ...
    const dataType = typeof message2.data?.type === "string" ? message2.data.type : "";
    const silentDataOnlyTypes = /* @__PURE__ */ new Set(["call_ended", "call_cancelled", "call_answered", "sync_unread"]);
...
function isCriticalNotification(type) {
  return type === "incoming_call" || type === "call_answered" || type === "call_ended" || type === "call_cancelled";
}
function isDataOnlyNotification(type) {
  return type === "incoming_call" || type === "call_answered" || type === "call_ended" || type === "call_cancelled" || type === "voicemail";
}
