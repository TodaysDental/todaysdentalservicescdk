...
// src/services/marketing/history.ts
var history_exports = {};
...
var handler = async (event) => {
  ...
  try {
    ...
    if (method === "GET") {
      ...
      const lastDays = event.queryStringParameters?.lastDays ? parseInt(event.queryStringParameters.lastDays) : void 0;
      if (!clinicId) {
        return {
          statusCode: 400,
          headers: corsHeaders,
