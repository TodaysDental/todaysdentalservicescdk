...
// src/services/chime/meeting-join-handler.ts
var meeting_join_handler_exports = {};
__export(meeting_join_handler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(meeting_join_handler_exports);
...
// src/services/chime/meeting-join-handler.ts
var ddb2 = import_lib_dynamodb2.DynamoDBDocumentClient.from(new import_client_dynamodb3.DynamoDBClient({}));
var CALL_QUEUE_TABLE = process.env.CALL_QUEUE_TABLE_NAME || "CallQueue";
var AGENT_PRESENCE_TABLE = process.env.AGENT_PRESENCE_TABLE_NAME || "AgentPresence";
var CALL_CENTER_MODULE = "Call Center";
