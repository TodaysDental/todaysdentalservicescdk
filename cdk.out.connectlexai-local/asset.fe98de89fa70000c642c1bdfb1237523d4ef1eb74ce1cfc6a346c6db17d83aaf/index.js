...
// src/services/clinic/costSeeder.ts
var costSeeder_exports = {};
__export(costSeeder_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(costSeeder_exports);
...
var handler = async (event) => {
  ...
  try {
    if (requestType === "Create" || requestType === "Update") {
      ...
      console.log(`Seeding ${items.length} clinic cost records...`);
    ...
    return {
      Status: "SUCCESS",
      PhysicalResourceId: `clinic-cost-seeder-${event.LogicalResourceId}`,
