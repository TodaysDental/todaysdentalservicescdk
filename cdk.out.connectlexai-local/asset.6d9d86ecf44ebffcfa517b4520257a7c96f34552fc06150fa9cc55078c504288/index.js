...
// src/services/rcs/get-messages.ts
...
var handler = async (event) => {
  ...
  try {
    ...
    const startKey = queryParams.startKey ? JSON.parse(decodeURIComponent(queryParams.startKey)) : void 0;
    const phoneNumber = queryParams.phone;
    const fromDate = queryParams.fromDate ? parseInt(queryParams.fromDate) : void 0;
    const toDate = queryParams.toDate ? parseInt(queryParams.toDate) : void 0;
    ...
    const result = await ddb.send(new import_lib_dynamodb.QueryCommand(queryCommand));
